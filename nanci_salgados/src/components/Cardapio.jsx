...
function Card({salgados}) {
  ...
  salgados.map((salgado)=>(
    <div  key={salgado.id} className='bg-white opacity-85 m-3 md:m-8 rounded-t-full rounded-b-[5000px] shadow-sm pb-2 flex flex-col max-w-[30vw] md:max-w-[20vw] items-center justify-center '>
  ...
  return(
    <div className='bg-white opacity-95 justify-center rounded-3xl shadow-md flex flex-col items-center w-[90%]  m-auto mt-12 md:mt-20 md:w-full md:rounded-none'>
      <div className='grid grid-cols-3 gap-4 md:gap-10 -mt-9'>
        <div className='bg-black    font-jet  text-white rounded-full w-min p-1  md:p-8 flex items-center justify-center flex-col md:text-2xl '>30<p > salgados</p><h4 className='text-yellow-500 md:text-2xl font-bold'>R$50</h4> </div>
        <div className='bg-red-700  font-jet  text-white rounded-full w-min  p-1 md:p-8  flex items-center justify-center flex-col md:text-2xl'> 50<p > salgados</p><h4 className='text-yellow-500 md:text-2xl font-bold '>R$70</h4></div>
        <div className='bg-white    font-jet  text-black rounded-full w-min  p-1 md:p-8 border border-orange-950 flex items-center justify-center flex-col md:text-2xl '>100<p > salgados</p> <h4 className='text-yellow-500 md:text-2xl font-bold'>R$100</h4> </div>
